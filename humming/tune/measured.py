...
def _normalize_meta(meta: "HummingLayerMeta | dict") -> "HummingLayerMeta":
    if isinstance(meta, dict):
        from humming.layer import HummingLayerMeta

        return HummingLayerMeta(**meta)
    return meta
...
def _default_progress_log_path(meta: "HummingLayerMeta", gemm_type: GemmType, flags: dict) -> str:
